...
//    public Object userRegister(@RequestBody LitemallUser user){
//        return  ResponseUtil.ok(userService.add(user))
//    }
    /**
     * 账号注册
     *
    ...
    public Object register(@RequestBody String body, HttpServletRequest request) {
        ...
        Integer integral =  JacksonUtil.parseString(body, "integral")== null? 0: Integer.valueOf(JacksonUtil.parseString(body, "integral"));
...
//        }
        ...
        user.setIntegral(BigDecimal.valueOf(integral));
        user.setUrl(url);
...
//      couponAssignService.assignForRegister(user.getId());
        ...
        // userInfo
        LitemallUser userInfo = new LitemallUser();
