...
const OrderIntegrealpay = '/order/integralpay'; // 积分支付
export function orderIntegrealpay(data) {
  return request({
    url: OrderIntegrealpay,
    method: 'post',
    data
  });
}
...
const DyAddressParse='/address/DyAddressParse'; //当前订单可用优惠券列表
export function dyAddressParseFun(query) {
  return request({
    url: DyAddressParse,
    method: 'get',
    params: query
