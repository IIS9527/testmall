...
public class LitemallUserService {
    ...
    public int addUserIntegral(Integer id, BigDecimal integral) {

        return  myUserMapper.addUserIntegral(id,integral);
    }
    public int reduceUserIntegral(Integer id, BigDecimal integral) {

        return  myUserMapper.reduceUserIntegral(id,integral);
    }
}
