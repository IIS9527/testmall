...
//import org.linlinjava.litemall.wx.service.DyAddressService;
...
public class WxAddressController extends GetRegionService {
	 ...
	 * 解析直播间链接
	 *
	 * @param videoAddress  用户ID

	 * @return 结果
	 */
	@GetMapping ("/DyAddressParse")
	public Object dyAddressParse(@PathParam("videoAddress") String videoAddress ) {
		if (StrUtil.isEmptyIfStr(videoAddress)){ return ResponseUtil.badArgument();}
