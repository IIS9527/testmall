<template>
  ...
  <div class="item_cell_group">
    <van-cell-group>
      <van-cell
          v-show="!goods.info.isDy"
        title="规格"
        isLink
        value="请选择"
        @click.native="skuClick"
      />
      <van-cell title="属性"  v-show="!goods.info.isDy" isLink @click.native="propsPopup = true"/>
      <van-cell title="开始时间"  v-model="startTime"  @click="getDatetimeBegin" >   </van-cell>
      <van-cell title="时长/小时"   >  <van-stepper  v-model="duration" integer /> </van-cell>
    ...
    <van-sku
      ...
      :stepper-title="goods.info.isDy?'机器数量':'购买数量'"
      :start-sale-num="goods.info.minNumber"
    />
<!--&lt;!&ndash;    @add-cart="addCart"&ndash;&gt; //可加入弹窗-->
...
import { Sku, Swipe, SwipeItem, GoodsAction, GoodsActionButton, GoodsActionIcon, Popup,Field ,DatetimePicker,Picker,Stepper} from 'vant';
