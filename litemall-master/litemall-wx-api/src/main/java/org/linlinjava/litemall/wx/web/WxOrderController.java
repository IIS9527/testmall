...
public class WxOrderController {
    ...
    public Object integralpay(@LoginUser Integer userId, @RequestBody String body, HttpServletRequest request) {
        return wxOrderService.integralpay(userId, body, request);
    }
    /**
     * 微信付款成功或失败回调接口
     * <p>
